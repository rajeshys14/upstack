...
public class LabRequestController {
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        try {
            ...
            return testRequestUpdateService.assignForLabTest(id, currentTester); // replace this line of code with your implementation
    ...
    public TestRequest updateLabTest(@PathVariable Long id,@RequestBody CreateLabResult createLabResult) {
        ...
        try {
            ...
            User currentUser = userLoggedInService.getLoggedInUser();
             ...
             TestRequest testRequest=testRequestUpdateService.updateLabTest(id, createLabResult, currentUser); // replace this line of code with your implementation
