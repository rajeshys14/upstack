...
public class ConsultationController {
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            return testRequestUpdateService.assignForConsultation(id, currentDoctor); // replace this line of code with your implementation
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            TestRequest testRequest = testRequestUpdateService.updateConsultation(id,testResult, currentUser); // replace this line of code with your implementation
